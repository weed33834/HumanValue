  ...
  <div class="admin-multi-agent">
    ...
    >
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="createSubmitting" @click="handleCreate">运行</el-button>
      </template>
    </el-dialog>
    ...
    <el-dialog v-model="resumeDialogVisible" title="恢复执行" width="540px">
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="resumeSubmitting" @click="handleResume">恢复</el-button>
      </template>
    </el-dialog>
    ...
    >
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="testSubmitting" @click="handleTest">执行测试</el-button>
      </template>
    </el-dialog>
  </div>
</template>
