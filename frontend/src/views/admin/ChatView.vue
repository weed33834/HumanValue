  ...
  <div class="chat-view">
    ...
    <div class="sidebar">
      ...
      <div class="session-list">
        <div
          ...
          :aria-current="
            chat.currentSession && chat.currentSession.id === s.id ? 'true' : undefined
          "
          role="button"
    ...
    <div class="main">
      ...
      <div v-else class="welcome">
        ...
        <h2>{{ $t('pages2.chat.welcomeTitle') }}</h2>
        <p>{{ $t('pages2.chat.welcomeSub') }}</p>
        <p class="welcome-hint">{{ $t('pages2.chat.hint') }}</p>
        <div class="welcome-chips">
          <el-tag v-for="c in capabilityChips" :key="c" class="cap-chip" @click="onSend(c)">
            {{ c }}
          </el-tag>
        </div>
        <p class="welcome-hint av-mt">{{ $t('pages2.chat.more') }}</p>
      </div>
      <ChatInput
        v-if="chat.currentSession"
        ref="chatInputRef"
