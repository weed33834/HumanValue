      ...
      <div class="control-row">
        <div class="control-left">
          <el-radio-group v-model="dateRange" @change="onRangeChange">
            <el-radio-button value="7d">{ $t('v.admin.AdminMetrics.3') }</el-radio-button>
            <el-radio-button value="30d">{ $t('v.admin.AdminMetrics.2') }</el-radio-button>
            <el-radio-button value="custom">{ $t('v.admin.AdminMetrics.4') }</el-radio-button>
          </el-radio-group>
          <template v-if="dateRange === 'custom'">
            <el-date-picker
              ...
              type="datetimerange"
              range-separator="至"
              start-:placeholder="$t('v.admin.AdminMetrics.0')"
              end-:placeholder="$t('v.admin.AdminMetrics.1')"
      ...
      <el-col :xs="24" :md="12">
        <el-card class="chart-card" shadow="never">
          <template #header>
            <div class="card-header">
              <span>评估状态分布</span>
              <span class="card-sub">processing / completed / error</span>
            </div>
          </template>
