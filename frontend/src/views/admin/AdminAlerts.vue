  ...
  <div class="admin-alerts av-fade-in-up">
    ...
    <div class="page-header mb-16">
      <div class="page-title">
        ...
        <span>{ $t('v.admin.AdminAlerts.5') }</span>
      </div>
    ...
    <div class="filter-bar mb-16">
      <el-select
        ...
        :placeholder="$t('v.admin.AdminAlerts.0')"
        clearable
        class="filter-select"
        @change="handleSearch"
      >
      ...
      <el-select
        ...
        :placeholder="$t('v.admin.AdminAlerts.1')"
        clearable
        class="filter-select"
        @change="handleSearch"
      >
      ...
      <el-select
        ...
        :placeholder="$t('v.admin.AdminAlerts.2')"
        clearable
        class="filter-select"
        @change="handleSearch"
      >
      ...
      <el-button @click="handleReset">{ $t('v.admin.AdminAlerts.7') }</el-button>
    </div>
    ...
    <el-card v-loading="loading">
      <el-table
        :data="alerts"
        stripe
        :empty-text="$t('v.admin.AdminAlerts.3')"
        @row-click="openDetail"
      >
        <el-table-column prop="id" label="ID" width="80" align="center" />
        <el-table-column :label="$t('v.admin.AdminAlerts.4')" width="140">
    ...
    <el-dialog v-model="detailVisible" title="告警详情" width="680px" @closed="detail = null">
      <el-descriptions v-if="detail" :column="2" border size="small">
        ...
        <el-descriptions-item label="触发时间">{{
          formatTime(detail.triggered_at)
        }}</el-descriptions-item>
        <el-descriptions-item label="确认时间">{{
          formatTime(detail.acknowledged_at)
        }}</el-descriptions-item>
