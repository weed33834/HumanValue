    ...
    <el-card class="login-card av-scale-in" shadow="always">
      <template #header>
        <div class="login-header">
          ...
          <h1 class="login-title">HumanValue</h1>
          <p class="login-subtitle">{ $t('v.LoginView.0') }</p>
        </div>
      </template>
        ...
        <el-tab-pane v-if="demoEnabled" label="演示模式" name="demo">
          <el-form label-position="top" class="login-form">
            <div class="demo-entry">
              <el-icon :size="32" color="var(--el-color-primary)"><User /></el-icon>
              <div class="demo-entry__info">
                <strong>管理者视角</strong>
                <p>以管理者身份体验全部功能，无需密码</p>
              </div>
            </div>
            <el-form-item>
...
import { Message, Lock, InfoFilled, WarningFilled, User } from '@element-plus/icons-vue'
