...
This repository is primarily hosted on [GitCode](https://gitcode.com/badhope/HumanValue).
A read-only mirror is available on [GitHub](https://github.com/weed33834/HumanValue) for
international users.
