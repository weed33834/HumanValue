...
class ABACEngine:
    ...
    async def check(
        ...
        policies, group_ids = await self._load_policies_and_groups(user_id, tenant_id)
    ...
    async def _load_subject_attrs(self, user_id: str, tenant_id: str) -> Dict[str, Any]:
    ...
    def _condition_satisfied(
        ...
        for key, expected in condition.items():
            ...
            if key == "subject.manages":
                ...
                owner_id = self._resolve_value(owner_ref, subject_attrs, resource_attrs)
                if owner_id is None:
                    return False
            ...
            expected_val = self._resolve_value(expected, subject_attrs, resource_attrs)
