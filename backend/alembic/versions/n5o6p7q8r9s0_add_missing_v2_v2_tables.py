...
def upgrade() -> None:
    ...
    if not _has_table(inspector, "webhook_events"):
        ...
        op.create_index(
            "ix_webhook_event_source_status", "webhook_events", ["source", "status"]
        )
        op.create_index(
            "ix_webhook_event_tenant_received",
            "webhook_events",
    ...
    if not _has_table(inspector, "scheduled_tasks"):
        ...
        op.create_index(
            "ix_scheduled_tasks_tenant_id", "scheduled_tasks", ["tenant_id"]
        )
        op.create_index(
            "ix_scheduled_task_tenant_type",
            "scheduled_tasks",
            ["tenant_id", "task_type"],
        )
    ...
    if not _has_table(inspector, "scheduled_task_runs"):
        ...
        op.create_index(
            "ix_scheduled_task_runs_tenant_id", "scheduled_task_runs", ["tenant_id"]
        )
        op.create_index(
            "ix_task_run_task_started", "scheduled_task_runs", ["task_id", "started_at"]
        )
    ...
    if not _has_table(inspector, "notifications"):
        op.create_table(
            ...
            sa.Column(
                "category", sa.String(32), nullable=False, server_default="system"
            ),
            sa.Column(
        ...
        op.create_index(
            "ix_notifications_notification_id", "notifications", ["notification_id"]
        )
        op.create_index("ix_notifications_user_id", "notifications", ["user_id"])
        op.create_index("ix_notifications_tenant_id", "notifications", ["tenant_id"])
        op.create_index(
            "ix_notif_tenant_user_read",
            "notifications",
    ...
    if not _has_table(inspector, "api_keys"):
        ...
        op.create_index(
            "ix_apikey_tenant_active", "api_keys", ["tenant_id", "is_active"]
        )
    ...
    if not _has_table(inspector, "search_configs"):
        ...
        op.create_index(
            "ix_search_configs_config_key", "search_configs", ["config_key"]
        )
    ...
    if not _has_table(inspector, "annotation_tasks"):
        ...
        op.create_index(
            "ix_annotation_tasks_tenant_id", "annotation_tasks", ["tenant_id"]
        )
        ...
        op.create_index(
            "ix_annotation_task_tenant_status",
            "annotation_tasks",
            ["tenant_id", "status"],
        )
        op.create_index(
            "ix_annotation_task_tenant_assignee",
            "annotation_tasks",
    ...
    if not _has_table(inspector, "sso_configs"):
        op.create_table(
            ...
            sa.Column(
                "config", sa.JSON(), nullable=False, server_default=sa.text("'{}'")
            ),
            sa.Column(
            ...
            sa.UniqueConstraint(
                "tenant_id", "provider_name", name="uix_tenant_sso_provider"
            ),
        )
        op.create_index("ix_sso_configs_tenant_id", "sso_configs", ["tenant_id"])
        op.create_index(
            "ix_sso_configs_provider_name", "sso_configs", ["provider_name"]
        )
        op.create_index(
            "ix_sso_config_tenant_type", "sso_configs", ["tenant_id", "provider_type"]
        )
    ...
    if not _has_table(inspector, "sso_sessions"):
        ...
        op.create_index(
            "ix_sso_sessions_provider_name", "sso_sessions", ["provider_name"]
        )
        op.create_index(
            "ix_sso_sessions_external_user_id", "sso_sessions", ["external_user_id"]
        )
        op.create_index(
            "ix_sso_sessions_internal_user_id", "sso_sessions", ["internal_user_id"]
        )
        op.create_index(
            "ix_sso_session_tenant_external",
            "sso_sessions",
    ...
    if not _has_table(inspector, "agent_templates"):
        op.create_table(
            ...
            sa.Column("description", sa.Text(), nullable=True),
            sa.Column(
                "category", sa.String(32), nullable=False, server_default="general"
            ),
            sa.Column(
                "template_config",
                sa.JSON(),
            ...
            sa.Column(
                "is_official", sa.Boolean(), nullable=False, server_default=sa.text("0")
            ),
            sa.Column(
                "created_at",
                sa.DateTime(timezone=True),
        ...
        op.create_index(
            "ix_agent_templates_tenant_id", "agent_templates", ["tenant_id"]
        )
        op.create_index("ix_agent_templates_category", "agent_templates", ["category"])
        op.create_index(
            "ix_agent_template_tenant_category",
            "agent_templates",
            ["tenant_id", "category"],
        )
        op.create_index("ix_agent_template_public", "agent_templates", ["is_public"])
        op.create_index(
            "ix_agent_template_official", "agent_templates", ["is_official"]
        )
    ...
    if not _has_table(inspector, "evaluation_datasets"):
        op.create_table(
            ...
            sa.Column("description", sa.Text(), nullable=True),
            sa.Column(
                "dataset_type", sa.String(16), nullable=False, server_default="test"
            ),
            sa.Column(
                "tags", sa.JSON(), nullable=False, server_default=sa.text("'[]'")
            ),
        ...
        op.create_index(
            "ix_evaluation_datasets_tenant_id", "evaluation_datasets", ["tenant_id"]
        )
        op.create_index("ix_evaluation_datasets_name", "evaluation_datasets", ["name"])
        op.create_index(
            "ix_evaluation_datasets_dataset_type",
            "evaluation_datasets",
            ["dataset_type"],
        )
        op.create_index(
            "ix_eval_dataset_tenant_type",
            "evaluation_datasets",
    ...
    if not _has_table(inspector, "tenant_quotas"):
        op.create_table(
            ...
            sa.Column(
                "max_api_keys", sa.Integer(), nullable=False, server_default="10"
            ),
            sa.Column(
                "current_requests_today",
                sa.Integer(),
                nullable=False,
                server_default="0",
            ),
            sa.Column(
                "current_tokens_today", sa.Integer(), nullable=False, server_default="0"
            ),
            ...
            sa.CheckConstraint(
                "max_requests_per_day >= 0", name="ck_quota_max_requests"
            ),
    ...
    if not _has_table(inspector, "quota_usage_logs"):
        ...
        op.create_index(
            "ix_quota_usage_logs_tenant_id", "quota_usage_logs", ["tenant_id"]
        )
        op.create_index(
            "ix_quota_usage_logs_usage_date", "quota_usage_logs", ["usage_date"]
        )
        op.create_index(
            "uix_quota_usage_tenant_date",
            "quota_usage_logs",
    ...
    if not _has_table(inspector, "budget_alerts"):
        op.create_table(
            ...
            sa.Column(
                "budget_type", sa.String(16), nullable=False, server_default="monthly"
            ),
            ...
            sa.Column(
                "alerted", sa.Boolean(), nullable=False, server_default=sa.text("0")
            ),
            sa.Column(
                "period_start",
                sa.DateTime(timezone=True),
        ...
        op.create_index(
            "ix_budget_tenant_type", "budget_alerts", ["tenant_id", "budget_type"]
        )
    ...
    if not _has_table(inspector, "billing_records"):
        ...
        op.create_index(
            "ix_billing_records_tenant_id", "billing_records", ["tenant_id"]
        )
        op.create_index("ix_billing_records_user_id", "billing_records", ["user_id"])
        op.create_index(
            "ix_billing_records_invoice_period", "billing_records", ["invoice_period"]
        )
        op.create_index(
            "ix_billing_tenant_billed", "billing_records", ["tenant_id", "billed_at"]
        )
        op.create_index(
            "ix_billing_tenant_user", "billing_records", ["tenant_id", "user_id"]
        )
        op.create_index(
            "ix_billing_tenant_endpoint",
            "billing_records",
    ...
    if not _has_table(inspector, "kb_data_sources"):
        ...
        op.create_index(
            "ix_kb_data_sources_tenant_id", "kb_data_sources", ["tenant_id"]
        )
        op.create_index(
            "ix_kb_ds_tenant_enabled", "kb_data_sources", ["tenant_id", "enabled"]
        )
    ...
    if not _has_table(inspector, "sensitive_words"):
        op.create_table(
            ...
            sa.Column(
                "category", sa.String(32), nullable=False, server_default="custom"
            ),
            sa.Column(
            ...
            sa.UniqueConstraint(
                "category", "word", name="uix_sensitive_word_category_word"
            ),
        )
        op.create_index(
            "ix_sensitive_words_tenant_id", "sensitive_words", ["tenant_id"]
        )
    ...
    if not _has_table(inspector, "sensitive_word_categories"):
        ...
        op.create_index(
            "ix_sensitive_word_categories_tenant_id",
            "sensitive_word_categories",
            ["tenant_id"],
        )
        op.create_index(
            "ix_sensitive_word_categories_name", "sensitive_word_categories", ["name"]
        )
        op.create_index(
            "ix_sensitive_category_active", "sensitive_word_categories", ["is_active"]
        )
    ...
    if not _has_table(inspector, "doc_parsing_tasks"):
        op.create_table(
            ...
            sa.Column(
                "parse_strategy", sa.String(16), nullable=False, server_default="auto"
            ),
            sa.Column(
                "status", sa.String(16), nullable=False, server_default="pending"
            ),
        ...
        op.create_index(
            "ix_doc_parsing_tasks_tenant_id", "doc_parsing_tasks", ["tenant_id"]
        )
        op.create_index(
            "ix_doc_parsing_tasks_file_type", "doc_parsing_tasks", ["file_type"]
        )
        op.create_index("ix_doc_parsing_tasks_status", "doc_parsing_tasks", ["status"])
        op.create_index(
            "ix_doc_task_tenant_status", "doc_parsing_tasks", ["tenant_id", "status"]
        )
        op.create_index(
            "ix_doc_task_tenant_created",
            "doc_parsing_tasks",
    ...
    if not _has_table(inspector, "environments"):
        op.create_table(
            ...
            sa.Column(
                "variables", sa.JSON(), nullable=False, server_default=sa.text("'{}'")
            ),
            sa.Column(
            ...
            sa.UniqueConstraint(
                "tenant_id", "name", name="uix_environment_tenant_name"
            ),
        )
        op.create_index("ix_environments_tenant_id", "environments", ["tenant_id"])
        op.create_index(
            "ix_environment_tenant_name", "environments", ["tenant_id", "name"]
        )
    ...
    if not _has_table(inspector, "alerts"):
        op.create_table(
            ...
            sa.Column(
                "severity", sa.String(16), nullable=False, server_default="warning"
            ),
            sa.Column("title", sa.String(256), nullable=False),
    ...
    if not _has_table(inspector, "agent_versions"):
        op.create_table(
            ...
            sa.Column(
                "agent_id",
                sa.Integer(),
                sa.ForeignKey("agent_presets.id", ondelete="CASCADE"),
                nullable=False,
            ),
            ...
            sa.UniqueConstraint(
                "agent_id", "version_number", name="uix_agent_version_number"
            ),
        )
        op.create_index("ix_agent_versions_tenant_id", "agent_versions", ["tenant_id"])
        op.create_index("ix_agent_versions_agent_id", "agent_versions", ["agent_id"])
        op.create_index(
            "ix_agent_version_agent_status", "agent_versions", ["agent_id", "status"]
        )
    ...
    if not _has_table(inspector, "model_instances"):
        op.create_table(
            ...
            sa.Column(
                "max_concurrent", sa.Integer(), nullable=False, server_default="10"
            ),
            sa.Column("current_load", sa.Integer(), nullable=False, server_default="0"),
            sa.Column(
                "health_status", sa.String(16), nullable=False, server_default="healthy"
            ),
        ...
        op.create_index(
            "ix_model_instances_tenant_id", "model_instances", ["tenant_id"]
        )
        op.create_index(
            "ix_model_instance_tenant_enabled",
            "model_instances",
            ["tenant_id", "enabled"],
        )
        op.create_index(
            "ix_model_instance_tenant_provider",
            "model_instances",
            ["tenant_id", "provider"],
        )
    ...
    if not _has_table(inspector, "load_balancer_configs"):
        op.create_table(
            ...
            sa.Column("name", sa.String(128), nullable=False),
            sa.Column(
                "strategy", sa.String(32), nullable=False, server_default="round_robin"
            ),
            sa.Column(
                "instances", sa.JSON(), nullable=False, server_default=sa.text("'[]'")
            ),
            sa.Column(
                "enabled", sa.Boolean(), nullable=False, server_default=sa.text("1")
            ),
        ...
        op.create_index(
            "ix_load_balancer_configs_tenant_id", "load_balancer_configs", ["tenant_id"]
        )
        op.create_index(
            "ix_lb_config_tenant_name", "load_balancer_configs", ["tenant_id", "name"]
        )
    ...
    if not _has_table(inspector, "conversation_metrics"):
        op.create_table(
            ...
            sa.Column(
                "status", sa.String(32), nullable=False, server_default="success"
            ),
            sa.Column("error_message", sa.Text(), nullable=True),
            sa.Column(
                "timestamp",
        ...
        op.create_index(
            "ix_conversation_metrics_tenant_id", "conversation_metrics", ["tenant_id"]
        )
        op.create_index(
            "ix_conversation_metrics_conversation_id",
            "conversation_metrics",
            ["conversation_id"],
        )
        op.create_index(
            "ix_conversation_metrics_user_id", "conversation_metrics", ["user_id"]
        )
        op.create_index(
            "ix_conversation_metrics_agent_id", "conversation_metrics", ["agent_id"]
        )
        op.create_index(
            "ix_conversation_metrics_model", "conversation_metrics", ["model"]
        )
        op.create_index(
            "ix_conv_metrics_tenant_time",
            "conversation_metrics",
            ["tenant_id", "timestamp"],
        )
        op.create_index(
            "ix_conv_metrics_tenant_user",
            "conversation_metrics",
            ["tenant_id", "user_id"],
        )
        op.create_index(
            "ix_conv_metrics_tenant_agent",
            "conversation_metrics",
            ["tenant_id", "agent_id"],
        )
        op.create_index(
            "ix_conv_metrics_tenant_model",
            "conversation_metrics",
            ["tenant_id", "model"],
        )
    ...
    if not _has_table(inspector, "model_fallback_chains"):
        ...
        op.create_index(
            "ix_model_fallback_chains_tenant_id", "model_fallback_chains", ["tenant_id"]
        )
        op.create_index(
            "ix_fallback_tenant_priority",
            "model_fallback_chains",
            ["tenant_id", "priority"],
        )
    ...
    if not _has_table(inspector, "rag_eval_tasks"):
        op.create_table(
            ...
            sa.Column(
                "completed_queries", sa.Integer(), nullable=False, server_default="0"
            ),
        ...
        op.create_index(
            "ix_rag_eval_task_tenant_status", "rag_eval_tasks", ["tenant_id", "status"]
        )
    ...
    if not _has_table(inspector, "api_health_metrics"):
        ...
        op.create_index(
            "ix_api_health_metrics_tenant_id", "api_health_metrics", ["tenant_id"]
        )
        op.create_index(
            "ix_api_health_metrics_endpoint", "api_health_metrics", ["endpoint"]
        )
        op.create_index(
            "ix_api_health_tenant_endpoint_time",
            "api_health_metrics",
    ...
    if not _has_table(inspector, "slo_definitions"):
        op.create_table(
            ...
            sa.Column(
                "target_success_rate", sa.Float(), nullable=False, server_default="0.99"
            ),
            sa.Column(
                "window_minutes", sa.Integer(), nullable=False, server_default="5"
            ),
            sa.Column(
                "enabled", sa.Boolean(), nullable=False, server_default=sa.text("1")
            ),
        ...
        op.create_index(
            "ix_slo_definitions_tenant_id", "slo_definitions", ["tenant_id"]
        )
        op.create_index("ix_slo_definitions_endpoint", "slo_definitions", ["endpoint"])
        op.create_index(
            "ix_slo_tenant_endpoint", "slo_definitions", ["tenant_id", "endpoint"]
        )
    ...
    if not _has_table(inspector, "prompt_optimization_tasks"):
        op.create_table(
            ...
            sa.Column(
                "task_type", sa.String(32), nullable=False, server_default="improve"
            ),
        ...
        op.create_index(
            "ix_prompt_optimization_tasks_tenant_id",
            "prompt_optimization_tasks",
            ["tenant_id"],
        )
        op.create_index(
            "ix_prompt_optimization_tasks_status",
            "prompt_optimization_tasks",
            ["status"],
        )
        op.create_index(
            "ix_prompt_opt_tenant_status",
            "prompt_optimization_tasks",
            ["tenant_id", "status"],
        )
    ...
    if not _has_table(inspector, "knowledge_graph_entities"):
        op.create_table(
            ...
            sa.Column("name", sa.String(256), nullable=False),
            sa.Column(
                "entity_type", sa.String(32), nullable=False, server_default="concept"
            ),
            sa.Column("description", sa.Text(), nullable=True),
        ...
        op.create_index(
            "ix_knowledge_graph_entities_tenant_id",
            "knowledge_graph_entities",
            ["tenant_id"],
        )
        op.create_index(
            "ix_kg_entity_tenant_name",
            "knowledge_graph_entities",
            ["tenant_id", "name"],
        )
        op.create_index(
            "ix_kg_entity_tenant_type",
            "knowledge_graph_entities",
    ...
    if not _has_table(inspector, "knowledge_graph_tasks"):
        ...
        op.create_index(
            "ix_knowledge_graph_tasks_tenant_id", "knowledge_graph_tasks", ["tenant_id"]
        )
        op.create_index(
            "ix_knowledge_graph_tasks_status", "knowledge_graph_tasks", ["status"]
        )
        op.create_index(
            "ix_kg_task_tenant_status", "knowledge_graph_tasks", ["tenant_id", "status"]
        )
        op.create_index(
            "ix_kg_task_tenant_created",
            "knowledge_graph_tasks",
            ["tenant_id", "created_at"],
        )
    ...
    if not _has_table(inspector, "nl2sql_queries"):
        ...
        op.create_index(
            "ix_nl2sql_queries_table_name", "nl2sql_queries", ["table_name"]
        )
        op.create_index("ix_nl2sql_queries_status", "nl2sql_queries", ["status"])
        op.create_index(
            "ix_nl2sql_query_tenant_created",
            "nl2sql_queries",
            ["tenant_id", "created_at"],
        )
        op.create_index(
            "ix_nl2sql_query_tenant_status", "nl2sql_queries", ["tenant_id", "status"]
        )
    ...
    if not _has_table(inspector, "nl2sql_schemas"):
        op.create_table(
            ...
            sa.UniqueConstraint(
                "tenant_id", "table_name", name="uix_tenant_nl2sql_table"
            ),
        )
        op.create_index("ix_nl2sql_schemas_tenant_id", "nl2sql_schemas", ["tenant_id"])
        op.create_index(
            "ix_nl2sql_schemas_table_name", "nl2sql_schemas", ["table_name"]
        )
    ...
    if not _has_table(inspector, "annotations"):
        op.create_table(
            ...
            sa.Column(
                "task_id",
                sa.Integer(),
                sa.ForeignKey("annotation_tasks.id"),
                nullable=False,
            ),
        ...
        op.create_index(
            "ix_annotation_tenant_task", "annotations", ["tenant_id", "task_id"]
        )
        op.create_index(
            "ix_annotation_tenant_annotator",
            "annotations",
            ["tenant_id", "annotator_id"],
        )
    ...
    if not _has_table(inspector, "agent_template_reviews"):
        ...
        op.create_index(
            "ix_agent_template_reviews_tenant_id",
            "agent_template_reviews",
            ["tenant_id"],
        )
        op.create_index(
            "ix_agent_template_reviews_template_id",
            "agent_template_reviews",
            ["template_id"],
        )
        op.create_index(
            "ix_template_review_template", "agent_template_reviews", ["template_id"]
        )
    ...
    if not _has_table(inspector, "dataset_items"):
        ...
        op.create_index(
            "ix_dataset_item_tenant_dataset",
            "dataset_items",
            ["tenant_id", "dataset_id"],
        )
        op.create_index(
            "ix_dataset_item_tenant_status", "dataset_items", ["tenant_id", "status"]
        )
    ...
    if not _has_table(inspector, "evaluation_tasks"):
        op.create_table(
            ...
            sa.Column(
                "judge_model", sa.String(32), nullable=False, server_default="L0"
            ),
            sa.Column("judge_prompt_template", sa.Text(), nullable=True),
            sa.Column(
                "metrics", sa.JSON(), nullable=False, server_default=sa.text("'[]'")
            ),
            sa.Column(
                "status", sa.String(16), nullable=False, server_default="pending"
            ),
        ...
        op.create_index(
            "ix_evaluation_tasks_tenant_id", "evaluation_tasks", ["tenant_id"]
        )
        op.create_index("ix_evaluation_tasks_name", "evaluation_tasks", ["name"])
        op.create_index(
            "ix_evaluation_tasks_dataset_id", "evaluation_tasks", ["dataset_id"]
        )
        op.create_index("ix_evaluation_tasks_status", "evaluation_tasks", ["status"])
        op.create_index(
            "ix_eval_task_tenant_dataset",
            "evaluation_tasks",
            ["tenant_id", "dataset_id"],
        )
        op.create_index(
            "ix_eval_task_tenant_status", "evaluation_tasks", ["tenant_id", "status"]
        )
    ...
    if not _has_table(inspector, "kb_sync_logs"):
        op.create_table(
            ...
            sa.Column(
                "data_source_id",
                sa.Integer(),
                sa.ForeignKey("kb_data_sources.id", ondelete="CASCADE"),
                nullable=False,
            ),
        ...
        op.create_index(
            "ix_kb_sync_logs_data_source_id", "kb_sync_logs", ["data_source_id"]
        )
        op.create_index(
            "ix_kb_sync_log_tenant_ds", "kb_sync_logs", ["tenant_id", "data_source_id"]
        )
    ...
    if not _has_table(inspector, "doc_parsing_results"):
        op.create_table(
            ...
            sa.Column(
                "task_id",
                sa.Integer(),
                sa.ForeignKey("doc_parsing_tasks.id", ondelete="CASCADE"),
                nullable=False,
            ),
            sa.Column("page_num", sa.Integer(), nullable=True),
            sa.Column(
                "content_type", sa.String(16), nullable=False, server_default="text"
            ),
            sa.Column("content", sa.Text(), nullable=False),
        ...
        op.create_index(
            "ix_doc_parsing_results_tenant_id", "doc_parsing_results", ["tenant_id"]
        )
        op.create_index(
            "ix_doc_parsing_results_task_id", "doc_parsing_results", ["task_id"]
        )
        op.create_index(
            "ix_doc_parsing_results_page_num", "doc_parsing_results", ["page_num"]
        )
        op.create_index(
            "ix_doc_parsing_results_content_type",
            "doc_parsing_results",
            ["content_type"],
        )
        op.create_index(
            "ix_doc_result_task_page", "doc_parsing_results", ["task_id", "page_num"]
        )
        op.create_index(
            "ix_doc_result_task_type",
            "doc_parsing_results",
    ...
    if not _has_table(inspector, "agent_publish_targets"):
        op.create_table(
            ...
            sa.Column("error_message", sa.Text(), nullable=True),
            sa.UniqueConstraint(
                "agent_id", "channel", name="uix_agent_publish_channel"
            ),
        )
        op.create_index(
            "ix_agent_publish_targets_tenant_id", "agent_publish_targets", ["tenant_id"]
        )
        op.create_index(
            "ix_agent_publish_targets_agent_id", "agent_publish_targets", ["agent_id"]
        )
        op.create_index(
            "ix_agent_publish_targets_version_id",
            "agent_publish_targets",
            ["version_id"],
        )
        op.create_index(
            "ix_agent_publish_agent_channel",
            "agent_publish_targets",
            ["agent_id", "channel"],
        )
    ...
    if not _has_table(inspector, "environment_deployments"):
        op.create_table(
            ...
            sa.Column(
                "status", sa.String(16), nullable=False, server_default="deployed"
            ),
            sa.Column(
                "config_snapshot",
                sa.JSON(),
        ...
        op.create_index(
            "ix_environment_deployments_tenant_id",
            "environment_deployments",
            ["tenant_id"],
        )
        op.create_index(
            "ix_environment_deployments_environment_id",
            "environment_deployments",
            ["environment_id"],
        )
        op.create_index(
            "ix_environment_deployments_agent_id",
            "environment_deployments",
            ["agent_id"],
        )
        op.create_index(
            "ix_environment_deployments_version_id",
            "environment_deployments",
            ["version_id"],
        )
        op.create_index(
            "ix_env_deploy_tenant_env",
            "environment_deployments",
            ["tenant_id", "environment_id"],
        )
        op.create_index(
            "ix_env_deploy_tenant_agent",
            "environment_deployments",
            ["tenant_id", "agent_id"],
        )
    ...
    if not _has_table(inspector, "gray_releases"):
        op.create_table(
            ...
            sa.Column(
                "release_type", sa.String(16), nullable=False, server_default="canary"
            ),
            sa.Column(
        ...
        op.create_index(
            "ix_gray_release_tenant_status", "gray_releases", ["tenant_id", "status"]
        )
        op.create_index(
            "ix_gray_release_tenant_agent", "gray_releases", ["tenant_id", "agent_id"]
        )
    ...
    if not _has_table(inspector, "knowledge_graph_relations"):
        op.create_table(
            ...
            sa.Column(
                "source_entity_id",
                sa.Integer(),
                sa.ForeignKey("knowledge_graph_entities.id", ondelete="CASCADE"),
                nullable=False,
            ),
            sa.Column(
                "target_entity_id",
        ...
        op.create_index(
            "ix_knowledge_graph_relations_tenant_id",
            "knowledge_graph_relations",
            ["tenant_id"],
        )
        op.create_index(
            "ix_knowledge_graph_relations_source_entity_id",
            "knowledge_graph_relations",
            ["source_entity_id"],
        )
        op.create_index(
            "ix_knowledge_graph_relations_target_entity_id",
            "knowledge_graph_relations",
            ["target_entity_id"],
        )
        op.create_index(
            "ix_kg_rel_tenant_source",
            "knowledge_graph_relations",
            ["tenant_id", "source_entity_id"],
        )
        op.create_index(
            "ix_kg_rel_tenant_target",
            "knowledge_graph_relations",
            ["tenant_id", "target_entity_id"],
        )
        op.create_index(
            "ix_kg_rel_tenant_type",
            "knowledge_graph_relations",
    ...
    if not _has_table(inspector, "rag_eval_results"):
        op.create_table(
            ...
            sa.Column(
                "task_id",
                sa.Integer(),
                sa.ForeignKey("rag_eval_tasks.id"),
                nullable=False,
            ),
            ...
            sa.Column(
                "precision_score", sa.Float(), nullable=False, server_default="0"
            ),
        ...
        op.create_index(
            "ix_rag_eval_results_tenant_id", "rag_eval_results", ["tenant_id"]
        )
        op.create_index("ix_rag_eval_results_task_id", "rag_eval_results", ["task_id"])
        op.create_index(
            "ix_rag_eval_result_tenant_task",
            "rag_eval_results",
            ["tenant_id", "task_id"],
        )
    ...
    if not _has_table(inspector, "evaluation_results"):
        op.create_table(
            ...
            sa.Column(
                "task_id",
                sa.Integer(),
                sa.ForeignKey("evaluation_tasks.id"),
                nullable=False,
            ),
            sa.Column(
                "dataset_item_id",
        ...
        op.create_index(
            "ix_evaluation_results_tenant_id", "evaluation_results", ["tenant_id"]
        )
        op.create_index(
            "ix_evaluation_results_task_id", "evaluation_results", ["task_id"]
        )
        op.create_index(
            "ix_evaluation_results_dataset_item_id",
            "evaluation_results",
            ["dataset_item_id"],
        )
        op.create_index(
            "ix_eval_result_tenant_task", "evaluation_results", ["tenant_id", "task_id"]
        )
        op.create_index(
            "ix_eval_result_tenant_item",
            "evaluation_results",
            ["tenant_id", "dataset_item_id"],
        )
