...
class TestVersionedPromptLoader:
    ...
    def test_version_distinct_from_current(self):
        ...
        # v1.2 起,仓库存在 v0.1/v0.2/v1.0/v1.1/v1.2 多个版本快照,
        # 当前生效版本(v1.2)必须与 v0.1 不同,且二者都能解析出版本号
        ...
        ), f"当前生效版本 {current_version} 应与 v0.1 不同(仓库已升级至 v1.2)"
        assert current_version == "v1.2"
